...
yay -Sy doas xorg-server xorg-xinit base-devel libx11 libxft libxinerama vim pacman-contrib reflector i3 fish rsync dolphin-emu mupen64plus xwallpaper compton xterm  acpi xorg-xrandr #gzdoom
